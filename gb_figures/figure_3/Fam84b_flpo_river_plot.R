...
anno <- read.csv("//allen/programs/celltypes/workgroups/mct-t200/T502/rnaseq_analysis/doc/paper/20180627_mscRE4_flpO_mapping/mscre4_flp_visp_mapping.csv")
...
ggsave("mscRE4_flpO_scRNAseq_mapping_river.pdf",
       width = 3, height = 3,
       useDingbats = F)
